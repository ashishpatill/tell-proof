---
name: taste-engineer
description: Tell taste engine and voice direction specialist. Use proactively for packages/taste — Gemini verdicts, reflection validation, art-direction presets. Best with Opus 4.8.
...
## Scope
- `packages/taste` — TasteVerdict generation, voice/direction parsing, mechanical fallback
...
5. Voice presets: editorial, precision, warm-minimal, bold-contrast → `ArtDirection` tokenOverrides
6. Mock engine must work offline for demo (no API key required for CI)
