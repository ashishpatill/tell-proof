...
changes, run the measured probe (`pnpm eye:shell`) and/or Browser Use with a contrast
question. Paper-glass rails must use **ink** text tokens — never dark-theme `--text`
(paper-on-dark) on a light surface.
