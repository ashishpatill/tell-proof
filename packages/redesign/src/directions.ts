...
export const DIRECTIONS: Record<string, Direction> = {
  editorial: {
    ...
    headingWeight: 600, bodyWeight: 400, ratio: 1.333, spacingBase: 8, radius: "2px",
    ...
    recipe: {
      ...
      ink: "#241E17", inkMuted: "#7A6C5C", texture: "fiber", contentMax: 1100, gridGap: 40,
      hero: {
        px: 88, transform: "none", weight: 600, tracking: "-0.03em", align: "left",
        italicAccentWord: true,
        eyebrow: { kind: "small-caps", text: "The Feature" }, decoration: "rules",
      },
      // ink-block + sharp radius — magazine CTA, not soft SaaS pills
      button: { kind: "ink-block", transform: "none", tracking: "0.01em", weight: 600 },
      link: { kind: "offset", thickness: "1.5px", offset: "3px" },
      card: { kind: "hairline", titleCase: "none", titleTracking: "-0.01em" },
      section: { padY: 112, divider: "hairline-top", alternate: true },
