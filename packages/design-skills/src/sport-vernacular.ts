...
const TENNIS: SportVernacularPack = {
  ...
  primaryFacts: [
    {
      id: "sets",
      label: "Set score",
      why: "Match arc lives here — who owns the stack of sets",
    },
    {
      id: "games-point",
      label: "Game score + server",
      why: "Point pressure is local to the game; server marker is non-negotiable",
    },
    {
      id: "pressure",
      label: "Break / set / match point flag",
      why: "Pressure states are the drama markers — textual, not color-only",
    },
    {
      id: "set-history",
      label: "Completed set line (best-of-5)",
      why: "Grand-arc matches need set-by-set momentum without burying the live point",
    },
  ],
  formatLenses: [
    {
      ...
      emphasize: ["breaks", "tie-break", "hold percentage"],
      demote: ["five-set endurance framing", "long physical narrative"],
    },
    {
      id: "best-of-5",
      label: "Best of 5",
      tempo: "Grand-arc stamina; momentum across sets",
      emphasize: ["set history", "physical narrative", "fifth-set framing"],
      demote: [],
    },
  ],
  categoryGaps: [
    ...
    "Same chrome for best-of-3 and best-of-5",
    "Challenge / review pending buried or color-only",
    "Editorial hero burying the nested spine during live play",
  ],
  uxRules: [
    ...
    "Format lens switches best-of-3 vs best-of-5 secondary facts",
    "Layout-stable nested spine — numbers update; columns do not jump",
    "Separate glance-live court board from sit-with notebook",
  ],
  technicalConcepts: [
    "advantage scoring",
    "tie-break",
    "challenge pending",
    "no-ad / deciding point variants",
    "set history as progressive disclosure",
  ],
  materialVernacular: ["clay dust", "grass sheen", "hard-court night", "baseline chalk"],
  tasteSeed: {
    aestheticLean: "refined-story",
    density: "balanced",
    motion: "light-scroll-reveals",
  ...
  brandAccent: "#2F5D50",
  multiPageRoutes: [
    { id: "home", path: "/baseline", routeClass: "home", purpose: "Live entry + court pulse + tournament arc" },
    { id: "live", path: "/baseline/live", routeClass: "live-match", purpose: "Nested score spine + server + pressure flags" },
    { id: "scorecard", path: "/baseline/scorecard", routeClass: "scorecard", purpose: "Set history + point tree after-play depth" },
    { id: "series", path: "/baseline/series", routeClass: "series", purpose: "Tournament / draw arc and fixtures" },
    { id: "rankings", path: "/baseline/rankings", routeClass: "rankings", purpose: "Singles rankings with surface lens" },
    { id: "notebook", path: "/baseline/notebook", routeClass: "notebook", purpose: "Sit-with editorial — technique and tempo" },
  ],
  shellContract: {
    stickyRegions: ["header", "live-rail", "score-spine"],
    primaryNavMaxItems: 6,
    liveSurface: "sticky nested score rail + live chips",
    mobileNavPattern: "primary six in header overflow + sticky live chip",
    footerDepth: "directory",
  },
  navInventory: [
    ...
    { id: "live", label: "Live", routeClass: "live-match", priority: "primary" },
    { id: "scorecard", label: "Scorecard", routeClass: "scorecard", priority: "primary" },
    { id: "series", label: "Tournaments", routeClass: "series", priority: "primary" },
    { id: "rankings", label: "Rankings", routeClass: "rankings", priority: "primary" },
    { id: "notebook", label: "Notebook", routeClass: "notebook", priority: "primary" },
  ],
  footerInventory: [
    { id: "match", title: "Match", links: ["Live", "Scorecard", "Pressure flags", "Challenges"] },
    { id: "compete", title: "Compete", links: ["Tournaments", "Draws", "Rankings", "Surfaces"] },
    { id: "read", title: "Read", links: ["Notebook", "Technique", "Archives"] },
    { id: "utility", title: "Utility", links: ["Latency", "Accessibility", "About"] },
  ],
  controlTaxonomy: [
    { id: "format-chip", role: "Toggle best-of-3 / best-of-5 lens", states: ["default", "selected", "hover", "focus-visible"] },
    { id: "live-chip", role: "Jump to live court", states: ["default", "live-pulse", "hover", "focus-visible"] },
    { id: "surface-tab", role: "Switch ranking / surface tables", states: ["default", "selected", "hover", "focus-visible"] },
    { id: "primary-cta", role: "Open court board / scorecard", states: ["default", "hover", "focus-visible", "disabled"] },
  ],
};
