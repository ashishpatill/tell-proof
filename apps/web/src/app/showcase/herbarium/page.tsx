...
/** Field guide showcase — taxon rail + specimen plate craft beat. */
export default function HerbariumShowcasePage() {
  const template = getTemplate("herbarium")!;
