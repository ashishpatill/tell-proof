...
export const metadata = {
  ...
  description:
    "Nine research-backed site kinds generated by Tell's design engine — proof sheets, not theme packs.",
};
...
export default function ShowcaseGalleryPage() {
  ...
  const featured = offerings.find((o) => o.key === "dossier") ?? offerings.find((o) => o.key === "foundry") ?? offerings.find((o) => o.key === "studio") ?? offerings[0]!;
